...
else if(isset($_POST['submit2']))
{
  $itemid = $_POST['itemid'];
  $_SESSION["id"]=$itemid;
  header('Refresh: 0;url=item1.php');
}
?>
<?php
...
<body  class="bg_img" align="center">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
    ...
    <a href='user1.php'><button type="submit" value="submit" name="submit1" class="btn">Go</button></a><br>
    ...
    <a href='item1.php'><button type="submit" value="submit" name="submit2" class="btn">Go</button></a><br><br>
